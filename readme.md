...
4. **Set up the API key:**
   Replace `YOUR_API_KEY` in `content_create.py` with your actual Gemini API key or set it as an environment variable:
   ```python
